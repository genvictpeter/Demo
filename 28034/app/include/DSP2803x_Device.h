...
#define  UV_600V		0x000
#define  UV_856V		0x100

#endif



#define MAX_int16_T                     ((int16)(32767))
#define MIN_int16_T                     ((int16)(-32768))
#define MAX_uint16_T                    ((uint16)(65535))
#define MIN_uint16_T                    ((uint16)(0))
#define MAX_int32_T                     ((int32)(2147483647))
#define MIN_int32_T                     ((int32)(-2147483647-1))
#define MAX_uint32_T                    ((uint32)(0xFFFFFFFFU))
#define MIN_uint32_T                    ((uint32)(0))
...
//#define   DA_EN	1			//DA enable Y2\FWD\REV disable
#define   LOADDAC			GpioDataRegs.GPADAT.bit.GPIO24 
#define   TARGET   1
//---------------------------------------------------------------------------

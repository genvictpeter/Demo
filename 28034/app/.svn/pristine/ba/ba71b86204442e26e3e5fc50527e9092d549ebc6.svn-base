...
__interrupt void TINT1_ISR(void);     // CPU-Timer 1
__interrupt void TINT2_ISR(void);     // CPU-Timer 2
...
__interrupt void rsvd_ISR1(void);           // for test
__interrupt void rsvd_ISR3(void);           // for test
